    ...
    <div style="font-family: Poppins">
      ...
      <!--  <tr>
          <td bgcolor="#003BB3" style="padding: 40px 64px; font-size: 14px; width: 73%;">
            <img src="https://res.cloudinary.com/dtsjiqrgd/image/upload/v1639046746/reverse_1_dnzzow.png" alt="tonote-icon">
          </td>
        </tr>
      </table> -->
          ...
          <td  style="background: #003BB3; padding: 40px 0;">
           <!-- <div style="padding-bottom: 34px">
            ...
            <div style="color: #fff; font-weight: 300; padding-bottom: 34px">
              <span>You are receiving this email because you have signed up on the Cabapp platform. <br />
              © ${new Date(new Date()).getFullYear()}, Cabapp . All rights reserved.
              </span>
            </div>
